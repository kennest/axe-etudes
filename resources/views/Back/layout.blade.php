		...
		<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
			...
			<ul class="nav navbar-nav navbar-right">
			                        ...
			                        @if (Auth::guard('etablissements')->guest())
			                            ...
			                            <li><a href="{{ url('/etablissements_login') }}">Connexion</a></li>
			                            <li><a href="{{ url('/etablissements_register') }}">S'enregistrer</a></li>
			                        @else
			                            <li class="dropdown">
			                                ...
			                                <ul class="dropdown-menu" role="menu">
			                                    <li>
			                                        <a href="{{ url('/etablissements_logout') }}"
			                                            onclick="event.preventDefault();
			                                                     document.getElementById('logout-form').submit();">
			                                            Logout
			                                        </a>

			                                        <form id="logout-form" action="{{ url('/etablissements_logout') }}" method="POST" style="display: none;">
			                                            {{ csrf_field() }}
			                                        </form>
			                                    </li>
			                                </ul>
